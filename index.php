      ...
      <div class="row">
        <div class="col">
          <div class="jumbotron flex-grow-0 flex-shrink-1" id="gateway">
			...
			<p class="lead text-center">Website untuk menampilkan informasi editor pada artikel situs detik.com beserta artikel yang telah diedit<br>Data yang diperoleh berasal dari struktur data hash yang diintegrasi dengan Web</p>
			<p class="text-center"><a class="btn btn-primary btn-lg" href="https://github.com/mr1dha/java-hash-structure-implemented-to-web" style="display:block;">Kunjungi Github →</a></p>
			<hr class="my-4">
